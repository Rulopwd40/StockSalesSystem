...
public class AddProductCommand implements Command {
    ...
    private final IhistorialpreciosRepository _historialPrecio;
    private final IhistorialcostosRepository _historialCosto;
    private HistorialPrecio historialPrecio;
    private HistorialCosto historialCosto;


    public AddProductCommand(IproductoService productoService, Producto producto, IhistorialpreciosRepository historialPrecio, IhistorialcostosRepository historialCosto) {
